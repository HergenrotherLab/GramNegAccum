...
Arg42$e <- read.delim("Arg42_e_rmsd.dat", sep=" ")[,2]
Arg42$f <- read.delim("Arg42_orig_rmsd.dat", sep=" ")[,2]
...
Arg82$e <- read.delim("Arg82_e_rmsd.dat", sep=" ")[,2]
Arg82$f <- read.delim("Arg82_orig_rmsd.dat", sep=" ")[,2]
...
Arg132$e <- read.delim("Arg132_e_rmsd.dat", sep=" ")[,2]
Arg132$f <- read.delim("Arg132_orig_rmsd.dat", sep=" ")[,2]
...
Asp113$e <- read.delim("Asp113_e_rmsd.dat", sep=" ")[,2]
Asp113$f <- read.delim("Asp113_orig_rmsd.dat", sep=" ")[,2]
...
Asp121$e <- read.delim("Asp121_e_rmsd.dat", sep=" ")[,2]
Asp121$f <- read.delim("Asp121_orig_rmsd.dat", sep=" ")[,2]
...
Glu117$e <- read.delim("Glu117_e_rmsd.dat", sep=" ")[,2]
Glu117$f <- read.delim("Glu117_orig_rmsd.dat", sep=" ")[,2]
