...
Asp113$e <- read.delim("Asp113_orig_r.dat", sep=" ")[,2]
...
Asp121$e <- read.delim("Asp121_orig_r.dat", sep=" ")[,2]
...
Glu117$e <- read.delim("Glu117_orig_r.dat", sep=" ")[,2]
...
dist.b <- data.frame(Asp113 = Asp113$b, Asp121 = Asp121$b, Glu117 = Glu117$b)
dist.b.melt <- melt(cbind(time, dist.b), id="time")
...
makePlotRep(dist.a.melt, "figs/r_b.png", "B")
